...
/*
 ...
 2. 在xcode中点击该文件，进入 preview 查看功能
 3. 创建图像输入源，及图形转化代理
...
class VisionObjectRecognitionViewController: ViewController {
    ...
    override func setupAVCapture() {
        super.setupAVCapture() // 基类avcapture图层获取
        
        // setup Vision parts
        setupLayers() // 创建展示later
        updateLayerGeometry() // 更新几何图形
        setupVision() // 加载学习模型
        
        // start the capture
        startCaptureSession() // 开始采集数据
    }
